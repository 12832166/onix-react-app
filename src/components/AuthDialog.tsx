  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-2xl p-6 w-full max-w-md z-50 transition-colors duration-300">
          <Dialog.Title className="text-2xl font-bold mb-6 text-black dark:text-white">
            {mode === 'signin' 
              ? t('auth.signIn') 
              : mode === 'signup' 
                ? t('auth.signUp')
          ...
          <Dialog.Close className="absolute right-4 top-4 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
            <X className="w-5 h-5" />
          </Dialog.Close>
          ...
          {mode === 'signin' && (
            <form onSubmit={signInForm.handleSubmit(onSignIn)} className="space-y-4">
              ...
              <Button type="submit" variant="default" size="lg" className="w-full" disabled={signInForm.formState.isSubmitting}>
          ...
          {mode === 'signup' && (
            <form onSubmit={signUpForm.handleSubmit(onSignUp)} className="space-y-4">
              ...
              <Button type="submit" variant="default" size="lg" className="w-full" disabled={signUpForm.formState.isSubmitting}>
