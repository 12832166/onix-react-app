...
const FavoritesPage = () => {
  ...
  if (favoriteProducts.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        <HeartOff className="w-16 h-16 text-gray-400 dark:text-gray-600 mb-4" />
        <h2 className="text-2xl font-bold mb-2 text-black dark:text-white">{t('favorites.empty')}</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">{t('favorites.emptyMessage')}</p>
        <Link
          to="/products"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-black dark:text-white">{t('favorites.title')}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {favoriteProducts.map((product) => {
          ...
          return (
            <div key={product.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg overflow-hidden group transition-colors duration-300">
